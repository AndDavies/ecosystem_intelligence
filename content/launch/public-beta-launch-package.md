# True North Map public beta launch package

Release: Monday, July 20, 2026 at 08:00 Atlantic
Canonical link: `https://truenorthmap.ca/`
Campaign: `public_beta_2026_07`

## UTM convention

Use one source-specific link per channel:

`https://truenorthmap.ca/?utm_source={source}&utm_medium={medium}&utm_campaign=public_beta_2026_07`
...
Do not add names, email addresses, or other personal identifiers to UTM values.
...
If your organization should be represented, the site includes a reviewed contribution path. I will publish the coverage gaps and improve the atlas based on what people actually try to find.
...
I am especially interested in whether it helps with a real task you already have: finding a supplier, partner, program, testing path, or capability. If something is missing or wrong, the most useful contribution is to use the correction, submission, or feedback controls in the product so I can preserve the context.

Andrew

## Included-organization message

Subject: Your organization is included in the True North Map public beta
...
[Profile URL with `utm_source=organization_outreach&utm_medium=email&utm_campaign=public_beta_2026_07`]

If anything is incomplete or inaccurate, you can use the Claim or suggest a correction control on the profile. Submissions are reviewed before the public record changes.
...
Preview: https://truenorthmap.ca/?utm_source=betakit&utm_medium=press&utm_campaign=public_beta_2026_07

I can provide the launch screenshots, a short product demonstration, corpus methodology, and an interview about the problem and the decision to build this as open Canadian ecosystem infrastructure.
...
Site: https://truenorthmap.ca/?utm_source=hacker_news&utm_medium=community&utm_campaign=public_beta_2026_07

I would particularly value technical discussion about maintaining evidence provenance, trustworthy structured data, and useful map/list interaction as the corpus grows.
...
https://truenorthmap.ca/?utm_source=reddit_sideproject&utm_medium=community&utm_campaign=public_beta_2026_07

I would be glad to compare notes with builders working on source provenance, public-interest datasets, geospatial discovery, or Canada-specific technology infrastructure.

For `r/BuyCanadian`, shorten this to two paragraphs and post only in the current self-promotion megathread.
