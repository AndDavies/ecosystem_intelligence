...
- Editorial Blue may separate the opening and source-led content. Evidence Green
  is reserved for verified-source meaning. Use Signal Yellow once, on the
  rectangular primary CTA below.
- Keep the verified sender, reply-to, lawful physical address, privacy link and
  functional MailerLite unsubscribe control. The layout must remain readable
  with images disabled, at mobile width and at 200% zoom.
