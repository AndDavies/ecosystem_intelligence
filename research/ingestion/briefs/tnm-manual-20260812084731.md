# Research Run Brief - tnm-manual-20260812084731
...
- Collection plan: research/ingestion/collection-plans-v1/tnm-manual-20260812084731.json
- Claim ledger: research/ingestion/claim-ledgers-v1/tnm-manual-20260812084731.json
...
10. Run `pnpm research:smoke -- --run research/ingestion/runs/tnm-manual-20260812084731.json --collection-plan research/ingestion/collection-plans-v1/tnm-manual-20260812084731.json --claims research/ingestion/claim-ledgers-v1/tnm-manual-20260812084731.json --prospects research/ingestion/prospect-inventories-v1/tnm-manual-20260812084731.json --leads research/ingestion/source-leads-v2/tnm-manual-20260812084731.json --candidates research/ingestion/candidate-batches-v2/tnm-manual-20260812084731.json --check-only` before creating derived review or staging files.
11. If the validated batch contains candidates, run `pnpm research:review -- research/ingestion/candidate-batches-v2/tnm-manual-20260812084731.json`, then `pnpm research:stage -- --run research/ingestion/runs/tnm-manual-20260812084731.json --candidates research/ingestion/candidate-batches-v2/tnm-manual-20260812084731.json`. An all-disposition batch stops after validation and does not create an empty Review intake.
12. Import only through `pnpm research:import -- --staging research/ingestion/staging/tnm-manual-20260812084731.json`, confirm candidates appear in Admin Review, then stop. Do not approve or publish.
