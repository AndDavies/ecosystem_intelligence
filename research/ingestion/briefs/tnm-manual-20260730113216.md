# Research Run Brief - tnm-manual-20260730113216
...
- Collection plan: research/ingestion/collection-plans-v1/tnm-manual-20260730113216.json
- Claim ledger: research/ingestion/claim-ledgers-v1/tnm-manual-20260730113216.json
...
- Published organizations in current atlas: 295
- Published capabilities in current atlas: 264
...
| --- | ---: | ---: |
| arctic-domain-awareness | 37 | 0 |
| underwater-isr | 43 | 0 |
| autonomous-patrol-and-monitoring | 137 | 0 |
| edge-data-processing | 35 | 0 |

| Technical domain | Published capabilities | Active-review capabilities |
| --- | ---: | ---: |
| sensing-and-isr | 187 | 0 |
| autonomous-systems | 148 | 0 |
| mission-software-and-data | 171 | 0 |
| space-and-earth-observation | 15 | 0 |
| aerospace-and-mobility | 41 | 0 |
| communications-and-cyber | 46 | 0 |
| test-training-and-sustainment | 52 | 0 |
| advanced-manufacturing-and-integration | 64 | 0 |
