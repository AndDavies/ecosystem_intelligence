# Research Run Brief - tnm-weekly-2026-08-03
...
- Collection plan: research/ingestion/collection-plans-v1/tnm-weekly-2026-08-03.json
- Claim ledger: research/ingestion/claim-ledgers-v1/tnm-weekly-2026-08-03.json
...
# Autonomous Research Coverage - 2026-08-03

- Durable Source Book rows: 479
- Operationally ranked Source Book rows: 116 (24%)
- Published organizations in current atlas: 385
- Published capabilities in current atlas: 347
...
| --- | ---: | ---: |
| arctic-domain-awareness | 60 | 0 |
| underwater-isr | 63 | 0 |
| autonomous-patrol-and-monitoring | 172 | 0 |
| edge-data-processing | 54 | 0 |

| Technical domain | Published capabilities | Active-review capabilities |
| --- | ---: | ---: |
| sensing-and-isr | 228 | 0 |
| autonomous-systems | 173 | 0 |
| mission-software-and-data | 202 | 0 |
| space-and-earth-observation | 32 | 0 |
| aerospace-and-mobility | 60 | 0 |
| communications-and-cyber | 68 | 0 |
| test-training-and-sustainment | 77 | 0 |
| advanced-manufacturing-and-integration | 104 | 0 |
