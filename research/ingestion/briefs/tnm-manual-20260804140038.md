# Research Run Brief - tnm-manual-20260804140038
...
- Collection plan: research/ingestion/collection-plans-v1/tnm-manual-20260804140038.json
- Claim ledger: research/ingestion/claim-ledgers-v1/tnm-manual-20260804140038.json
...
# Autonomous Research Coverage - 2026-08-04

- Durable Source Book rows: 491
- Operationally ranked Source Book rows: 128 (26%)
- Published organizations in current atlas: 395
- Published capabilities in current atlas: 357
...
| underwater-isr | 65 | 0 |
| autonomous-patrol-and-monitoring | 178 | 0 |
| edge-data-processing | 56 | 0 |

| Technical domain | Published capabilities | Active-review capabilities |
| --- | ---: | ---: |
| sensing-and-isr | 234 | 0 |
| autonomous-systems | 180 | 0 |
| mission-software-and-data | 204 | 0 |
| space-and-earth-observation | 32 | 0 |
| aerospace-and-mobility | 62 | 0 |
| communications-and-cyber | 68 | 0 |
| test-training-and-sustainment | 78 | 0 |
| advanced-manufacturing-and-integration | 106 | 0 |
