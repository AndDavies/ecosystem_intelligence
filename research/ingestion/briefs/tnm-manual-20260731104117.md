# Research Run Brief - tnm-manual-20260731104117

- Trigger: manual
- Mode: discovery_batch
- Selected coverage view: ecosystem_support
- Selected gap: organization-kind:incubator
- Reason: 8 published or pending incubator records cover only 67% of the working saturation target of 12.
...
- Collection plan: research/ingestion/collection-plans-v1/tnm-manual-20260731104117.json
- Claim ledger: research/ingestion/claim-ledgers-v1/tnm-manual-20260731104117.json
...
- Published organizations in current atlas: 305
