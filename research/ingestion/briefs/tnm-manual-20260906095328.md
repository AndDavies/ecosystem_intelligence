# Research Run Brief - tnm-manual-20260906095328

- Trigger: manual
- Mode: dossier_enrichment
- Selected coverage view: supply
- Selected gap: dossier-targets:2
- Reason: The owner selected 2 exact published organizations for comprehensive, review-first organization-dossier enrichment without automatic activation or publication; the complete target identities are recorded in the collection plan.
- Review-packet capacity: 2 candidates; this is an operational envelope, not a discovery-yield or evidence threshold.
- Minimum prospects: 2
...
- Target candidates: 2
- Collection plan: research/ingestion/collection-plans-v1/tnm-manual-20260906095328.json
- Claim ledger: research/ingestion/claim-ledgers-v1/tnm-manual-20260906095328.json
...
10. Preview the deterministic guarded sequence with `pnpm research:finalize -- --run research/ingestion/runs/tnm-manual-20260906095328.json --plan`. The standalone diagnostic uses the same gate; do not repeat it after successful finalization: `pnpm research:smoke -- --run research/ingestion/runs/tnm-manual-20260906095328.json --collection-plan research/ingestion/collection-plans-v1/tnm-manual-20260906095328.json --claims research/ingestion/claim-ledgers-v1/tnm-manual-20260906095328.json --prospects research/ingestion/prospect-inventories-v1/tnm-manual-20260906095328.json --signals research/ingestion/signal-batches-v1/tnm-manual-20260906095328.json --leads research/ingestion/source-leads-v2/tnm-manual-20260906095328.json --candidates research/ingestion/candidate-batches-v2/tnm-manual-20260906095328.json --check-only`.
11. When the complete batch is final and private intake is authorized, run `pnpm research:finalize -- --run research/ingestion/runs/tnm-manual-20260906095328.json --apply`. It prepares any missing private organization-logo dispositions, validates the complete artifact set once, generates review/staging artifacts only when candidates exist, imports only through the tracked path, and reconciles the exact run in production. Use `--file-only` instead when Admin Review intake is unavailable but local review/staging artifacts are explicitly needed.
