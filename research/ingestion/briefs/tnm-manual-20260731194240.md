# Research Run Brief - tnm-manual-20260731194240

- Trigger: manual
- Mode: discovery_batch
- Selected coverage view: supply
- Selected gap: technical-domain:space-and-earth-observation
- Reason: Space and earth observation is the lowest-count live technical-domain lane at 22 published capabilities. Five completed same-day deep-strike discovery passes make another automatic deep-strike pass lower-yield, so this run targets distinct Canadian space, satellite, geospatial, and Earth-observation companies.
...
- Collection plan: research/ingestion/collection-plans-v1/tnm-manual-20260731194240.json
- Claim ledger: research/ingestion/claim-ledgers-v1/tnm-manual-20260731194240.json
...
- Published organizations in current atlas: 365
- Published capabilities in current atlas: 324
...
| --- | ---: | ---: |
| arctic-domain-awareness | 52 | 0 |
| underwater-isr | 52 | 0 |
| autonomous-patrol-and-monitoring | 165 | 0 |
| edge-data-processing | 50 | 0 |

| Technical domain | Published capabilities | Active-review capabilities |
| --- | ---: | ---: |
| sensing-and-isr | 208 | 0 |
| autonomous-systems | 158 | 0 |
| mission-software-and-data | 191 | 0 |
| space-and-earth-observation | 22 | 0 |
| aerospace-and-mobility | 57 | 0 |
| communications-and-cyber | 65 | 0 |
| test-training-and-sustainment | 69 | 0 |
| advanced-manufacturing-and-integration | 102 | 0 |
