...
- Candidate file: `research/ingestion/candidate-batches/arctic-domain-awareness-pilot.json`
...
- Candidate records are intentionally staged outside app/supabase/seed until a human reviewer approves import.
...
- [ ] Promotion should proceed into `app/supabase/seed`.
