...
- `ingestion/` contains the committed, typed review lineage: atomic signal batches, source leads, candidate batches, schemas, review packets, reports, and staging exports. See [`ingestion/README.md`](./ingestion/README.md) for the tracking boundary.
