...
Research remains review-first. Candidate records are validated here before explicit promotion into canonical Supabase tables or the clean `app/supabase/seed.sql` snapshot. Agents never publish autonomously.
