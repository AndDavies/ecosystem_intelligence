...
- `governance/` contains the active PRD, project structure, research contract, current release plan references, historical audits, and development logs.
...
The active operating documents are `PRD.md`, `Project Structure.md`, `Autonomous Ecosystem Research Pipeline.md`, and `Research Agent Schema And Source Contract.md`. Dated audits and development logs are historical evidence, not current task lists or implementation instructions.
