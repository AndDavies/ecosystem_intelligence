...
The active operating documents are `PRD.md`, `Project Structure.md`, `Admin Workflow And Data Contract.md`, `Autonomous Ecosystem Research Pipeline.md`, and `Research Agent Schema And Source Contract.md`. Dated audits and development logs are historical evidence, not current task lists or implementation instructions.
