...
Start every material task with `governance/True North Map Project Overview.md`, `governance/Project Status.md`, and `governance/Cross-System Change And Regression Contract.md`. Use `governance/Skills And Automation Map.md` for the research and visibility workflow boundaries. The PRD, Project Structure, Admin Workflow and Data Contract, Autonomous Ecosystem Research Pipeline, and Research Agent Schema and Source Contract remain the supporting contracts. Dated audits and development logs are historical evidence, not current task lists or implementation instructions.
