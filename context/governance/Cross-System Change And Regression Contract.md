...
| Organization, capability, region, map, or search | Compact national projection, pagination, filters, URL state, API shape, Ask True North eligibility, exports | Overview and relevant data/admin contract | Tests, lint, 1,000-marker fixture where map loading changes, public API and route smoke |
