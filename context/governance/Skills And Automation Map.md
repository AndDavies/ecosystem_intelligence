...
| EX-04 | External system | Yes | MailerLite True North Map workspace | Consent sync, webhook, automatic welcome, or Andrew campaign action | Supabase consent and Andrew-reviewed campaign | Subscriber group, lifecycle state, North Signal delivery | Delivery surface, not consent authority or auth mail | Live signup, sync, Gmail delivery, link, webhook, unsubscribe and sender checks | Andrew sends campaigns | Active production; Signals-led welcome verified, weekly template remains pre-send | Andrew Davies | 2026-08-10 |
...
- North Signal changes: 28-feed registry and health reconciliation; v2 packet, durable-source, Signals-link and no-Brief validation; acquisition-route consent/telemetry tests; Andrew still controls MailerLite delivery.
