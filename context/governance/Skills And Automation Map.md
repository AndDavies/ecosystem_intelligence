...
| Canadian Defence Signals scan | Daily at 07:00 Atlantic | Validated edition in isolated `signal_*` tables plus private run and social-draft rows, or a valid no-publish run | Deterministic source/significance contract; no core-corpus or external-post authority |
