...
- The application runtime is pinned to Node 24. GitHub Actions runs the complete release gate on every change to `main`, CodeQL scans JavaScript and TypeScript, Dependabot monitors the application dependency graph, and GitHub secret scanning and push protection remain enabled.
