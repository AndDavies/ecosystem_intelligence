...
- The internal-link presentation graph is assembled deterministically from already published records. Organizations remain the principal destination; ownership and reviewed canonical relationships outrank Mission Area, Public Need, program and editorial paths, while shared-mission or shared-domain similarity is labelled **Similar areas of work** and never presented as partnership or endorsement. The shared continuation module is bounded to three organizations, three mission/ecosystem paths and two Signals or Briefs. Inline editorial links remain North Ink with a persistent underline and Signal Yellow keyboard focus. Eligible database edges are measured by the private `links:inventory` report; rendered anchors, roles, contextual degree and click depth remain part of the explicitly authorized launch audit.
