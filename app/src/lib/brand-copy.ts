/**
 * Canonical public message hierarchy. Keep sales and acquisition surfaces
 * outcome-led; methodology and review language remains in its own context.
 */
export const brandCopy = {
  category: "Canadian defence capability discovery",
  categoryLabel: "CANADIAN DEFENCE CAPABILITY DISCOVERY",
  headline: "Canada is building more than most people can see.",
  headlineLead: "Canada is building",
  headlineRest: "more than most people can see.",
