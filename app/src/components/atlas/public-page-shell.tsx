  ...
  return (
    <main className="atlas-page min-h-screen bg-[#f7f9fc] text-[#101828]">
      ...
      <div className="atlas-frame py-6 sm:py-8">
        <Link href={backHref} className="inline-flex items-center gap-2 text-xs font-semibold text-[#475467] no-underline hover:text-[#0756d9] hover:no-underline">
        ...
        <header className="mt-5 flex flex-col gap-5 border-b border-[#d0d5dd] pb-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-4xl">
            <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-[#0756d9]">{eyebrow}</p>
...
export function PublicCard({
  ...
  return (
    <section className={`rounded-lg border border-[#d0d5dd] bg-white p-5 shadow-[0_1px_3px_rgba(16,24,40,0.04)] sm:p-6 ${className}`}>
      {eyebrow ? <p className="text-[10px] font-bold uppercase tracking-[0.13em] text-[#0756d9]">{eyebrow}</p> : null}
