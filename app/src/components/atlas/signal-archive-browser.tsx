  ...
  return <section className="mt-14" aria-labelledby="signals-archive-heading">
    <div className="border-b border-[var(--atlas-border)] pb-5">
      ...
      <div className="mt-3 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
        <div><h2 id="signals-archive-heading" className="text-3xl font-extrabold tracking-[-0.04em]">Follow the record over time.</h2><p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--atlas-muted)]">Search by development, organization, technology, or one of the standard editorial tags.</p></div>
