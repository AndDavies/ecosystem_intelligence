      ...
      {mobileBannerOpen ? (
        <aside ref={mobileBannerRef} className="fixed inset-x-3 bottom-3 z-[1200] border border-[var(--atlas-border-strong)] border-l-4 border-l-[var(--atlas-signal)] bg-white p-3 shadow-[var(--atlas-shadow-float)] sm:hidden" aria-label="North Signal weekly briefing">
          <div className="flex items-start gap-3">
            ...
            >
              <strong className="block text-sm text-[var(--atlas-ink)]">Understand the week in Canadian defence.</strong>
        ...
        <Dialog.Portal>
          ...
          >
            <div className="p-5 sm:p-6">
              ...
              <Dialog.Title id="pilot-updates-title" className="mt-3 max-w-[20ch] font-[family-name:var(--font-barlow)] text-[clamp(1.7rem,4vw,2.15rem)] font-extrabold leading-[1.04] tracking-[-0.045em] text-[var(--atlas-ink)]">Understand the week in Canadian defence.</Dialog.Title>
