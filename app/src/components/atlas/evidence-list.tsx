    ...
    <ul className="divide-y divide-[#eaecf0]">
      {unique.map((citation) => (
        <li key={citation.id} className="py-3 first:pt-0 last:pb-0">
          <a href={citation.sourceUrl} target="_blank" rel="noreferrer" className="group inline-flex items-start gap-1.5 text-sm font-semibold text-[#007f98] no-underline hover:underline">
