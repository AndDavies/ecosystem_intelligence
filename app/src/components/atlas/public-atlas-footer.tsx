  ...
  return (
    <footer className="mt-8 border-t border-[#c9dce0] py-6 text-xs text-[#667085]">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="font-semibold text-[#344054]">Independent project by Andrew Davies</p>
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <Link href="/methodology" className="font-semibold text-[#475467] no-underline hover:text-[#007f98] hover:underline">Methodology</Link>
          <Link href="/contact" className="font-semibold text-[#475467] no-underline hover:text-[#007f98] hover:underline">Contact</Link>
          <Link href="/terms" className="font-semibold text-[#475467] no-underline hover:text-[#007f98] hover:underline">Terms</Link>
          <Link href="/demand" className="font-semibold text-[#475467] no-underline hover:text-[#007f98] hover:underline">Public demand signals</Link>
        </div>
      </div>
    </footer>
  );
