...
export function PaginationNav({
  ...
  return (
    <nav className="mt-7 flex flex-col gap-3 border-t border-[var(--atlas-border)] py-4 sm:flex-row sm:items-center sm:justify-between" aria-label={`${itemLabel} pages`}>
