...
export default async function AdminSubscribersPage() {
  ...
  return (
    <PublicPageShell variant="admin" eyebrow="Private administration" title="Update subscribers" description="See who asked to hear from True North Map. Consent remains recorded here even when delivery is handled by an external mailing service." actions={<span className="rounded bg-[var(--admin-surface-subtle)] px-3 py-2 text-xs font-semibold text-[var(--admin-muted-strong)]">administrator · {user.email}</span>}>
      <AdminNav />
