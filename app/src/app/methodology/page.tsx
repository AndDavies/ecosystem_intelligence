...
export default function MethodologyPage() {
  return (
    <PublicPageShell eyebrow="Evidence and human review" title="Useful intelligence should be inspectable." description="True North Map separates what public sources say from our reviewed assessment and shows what remains unknown." backHref="/" backLabel="Home" actions={<Link href="/how-it-works" className="atlas-primary-button h-11 px-5 text-sm">See the visitor journey <ArrowRight className="size-4" /></Link>}>
      ...
      <PublicCard title="How to read ‘Where this technology may help’" eyebrow="Important caveat" className="mt-5"><p className="text-sm leading-6 text-[var(--atlas-muted)]">A technology-to-demand connection means a person reviewed the technology, the released public need, and the supporting sources, then judged the connection useful enough to show. It does not establish procurement eligibility, customer interest, government endorsement, classified demand, or a formal business opportunity. Users must conduct their own diligence.</p></PublicCard>
