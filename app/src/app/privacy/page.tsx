  ...
  return (
    <PublicPageShell eyebrow="Public-beta governance" title="Privacy and participation" description="Ecosystem Intelligence collects only the information needed to operate private workflows, improve discovery, and respond to voluntary contact.">
      <div className="grid gap-5 lg:grid-cols-2">
        <PublicCard title="Sign-in and private work" eyebrow="User-controlled actions"><ShieldCheck className="mb-3 size-5 text-[#007f98]" /><p className="text-sm leading-6 text-[#475467]">You can use Google or a passwordless email link. Google provides a verified email and basic profile information; the service never receives your Google or email password. Working Lists, contributions, and connection requests are private to you and the authorized administrator.</p></PublicCard>
      ...
      <PublicCard title="Your choices" eyebrow="Access, correction, and removal" className="mt-5"><p className="text-sm leading-6 text-[#475467]">You can browse without an account, manage or delete your account and owner-bound private data from <a href="/account" className="font-semibold text-[#007f98] underline">Your account</a>, dismiss the update prompt for 30 days, submit a correction, and unsubscribe from future updates during deletion. Published records and anonymized audit history are not removed with a member account. Use the <a href="/contact" className="font-semibold text-[#007f98] underline">contact form</a> for another access, correction, or privacy request. Last updated July 17, 2026.</p></PublicCard>
    </PublicPageShell>
  );
}
