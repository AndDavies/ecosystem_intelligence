...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#f7f7f3", color: "#242827", padding: "64px 72px", fontFamily: "sans-serif", borderTop: "12px solid #f5e900" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", maxWidth: 1020 }}><div style={{ display: "flex", color: "#126147", fontSize: 20, fontWeight: 800, letterSpacing: 1.2 }}>{brandCopy.categoryLabel}</div><div style={{ display: "flex", flexDirection: "column", marginTop: 18, fontSize: 58, lineHeight: 0.98, letterSpacing: -2.6, fontWeight: 900 }}><span style={{ display: "flex", alignSelf: "flex-start", background: "#f5e900", color: "#242827", padding: "2px 9px" }}>{brandCopy.headlineLead}</span><span style={{ display: "flex", marginTop: 8 }}>{brandCopy.headlineRest}</span></div><div style={{ marginTop: 22, width: 120, height: 6, background: "#f5e900" }} /></div>
