  ...
  return (
    <PublicPageShell eyebrow="Public Beta" title="Terms of use" description="Use the ecosystem map to discover possibilities, verify important decisions independently, and contribute responsibly.">
      <div className="space-y-5">
        ...
        <PublicCard title="No warranty or eligibility determination" eyebrow="Use your judgment"><p className="text-sm leading-6 text-[var(--atlas-muted)]">Records are assembled from reviewed public sources and may be incomplete, stale, or disputed. They are not legal, investment, security, procurement, or due-diligence advice. Inclusion, ranking, a “Where It Fits” assessment, or connection facilitation does not establish endorsement, certification, eligibility, or suitability.</p></PublicCard>
        <PublicCard title="AI-assisted discovery" eyebrow="Derived read"><p className="text-sm leading-6 text-[var(--atlas-muted)]">Ask True North ranks only published records and links its reasoning to available public sources. Its fit labels and summaries are generated interpretations, not source-backed facts, recommendations, procurement guidance, or due diligence. Do not submit classified, confidential, proprietary, unlawful, or personal information.</p></PublicCard>
        ...
        <PublicCard title="Corrections and changes" eyebrow="Living beta"><p className="text-sm leading-6 text-[var(--atlas-muted)]">The service, coverage, and these terms may change as the beta develops. Use the correction workflow or contact form to report a material issue. Last updated July 20, 2026.</p></PublicCard>
      </div>
    </PublicPageShell>
  );
}
