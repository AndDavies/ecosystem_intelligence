...
export default async function SignalsPage() {
  ...
  >
    ...
    {latest ? <article className={`relative mt-4 grid overflow-hidden rounded-[18px] bg-[var(--atlas-ink)] text-white shadow-[0_18px_48px_rgba(36,40,39,0.14)] ${latest.heroImage ? "md:grid-cols-[minmax(250px,0.78fr)_minmax(0,1.22fr)]" : ""}`}>
      {latest.heroImage ? <SignalHeroImage image={latest.heroImage} priority className="min-h-[220px] md:min-h-full" /> : null}
